<script lang="ts">let { ballTopLeft = '#FF3E00', ballTopRight = '#F8B334', ballBottomLeft = '#40B3FF', ballBottomRight = '#676778', duration = '1.5s', unit = 'px', size = '60', pause = false } = $props();
export {};
</script>
