...
type RuleToken = { id: string; toString: (d: Date) => string }
type FormatToken = string | RuleToken
type ParseResult = { date: Date | null; missingPunctuation: string }


export default class Parser
{
    public static parse(str: string, tokens: FormatToken[], baseDate: Date | null): ParseResult
    {
        ...
        const monthLength = DateUtils.getMonthLength(year, month)
        if (day > monthLength) {
          valid = false
        }
