...
{#snippet small()}
    <button type="button" aria-label="first" class="small" class:disabled={table.currentPage === 1} onclick={() => table.setPage(1)}>
    ...
    <button type="button" aria-label="last" class="small" class:disabled={table.currentPage === table.pageCount} onclick={() => table.setPage('last')}>
