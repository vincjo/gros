...
{#snippet nopage()}
    <button type="button" class={['small', { disabled: table.currentPage === 1 }]} onclick={() => table.setPage('previous')}>
        &#10094;
    </button>
...
{#snippet small()}
    <button type="button" aria-label="first" class={['small', { disabled: table.currentPage === 1 }]} onclick={() => table.setPage(1)}>
    ...
    <button type="button" aria-label="previous" class={{ disabled: table.currentPage === 1 }} onclick={() => table.setPage('previous')}>
    ...
    <button type="button" aria-label="next" class={{ disabled: table.currentPage === table.pageCount }} onclick={() => table.setPage('next')}>
    ...
    <button type="button" aria-label="last" class={['small', { disabled: table.currentPage === table.pageCount }]} onclick={() => table.setPage('last')}>
...
{#snippet ellipsis()}
    ...
    {#each table.pagesWithEllipsis as page}
        {#if page === null}
            <button type="button" aria-label="ellipse" class="ellipse">
