...
<section>
    <aside>
        ...
        <div>
            ...
            <div>
                <img
                    src="https://img.shields.io/npm/dt/gros?color=%23{$color}"
                    alt="npm downloads"
                />
