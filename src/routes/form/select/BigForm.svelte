...
<section>
    ...
    <Select big {errors} multiple field="pet" label="Pets" required icon="pets" options={pets} bind:value={form.pet}/>
    <Select big {errors}  field="incomes" label="Incomes" icon="euro_symbol" options={incomes} bind:value={form.incomes}/>
    <Select big {errors}  field="isSleeping" label="Sleeping?" icon="hotel" options={isSleeping} bind:value={form.isSleeping}/>
